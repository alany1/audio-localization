...
model = AudioCLIP(pretrained="scripts/AudioCLIP/assets/AudioCLIP-Full-Training.pt")
model.eval()
...
audio_path = "scripts/examples/guitar.mp3"
...
# save the result
torch.save(audio_embeddings, "scripts/embeddings/alan_dirt.pt")
print("Audio embeddings saved to embeddings/alan_dirt.pt")