...
if __name__ == '__main__':    
    audio_file = FileArgs()
    audio_file.source_path = 'scripts/examples/drums.mp3'
    ...
    # torch.save(frame_embeds, 'scripts/band_embeddings.t')
    ...
    cv2.imwrite("scripts/drums_heatmap.jpg", beach_img)

    # overlay heatmap
    blended = overlay_heatmap(first_frame, beach_img)
    blended.save("scripts/overlay_drums.jpg")
